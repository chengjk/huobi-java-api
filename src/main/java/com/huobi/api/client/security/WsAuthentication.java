...
/**
 * created by jacky. 2018/9/26 5:12 PM
 */
public class WsAuthentication {
    ...
    public String toAuth() {
        ...
        String now = gmtNow();
        String signature = createSignature(now);
        String format = "{" +
                "\"SignatureVersion\":\"%s\"," +
                "\"op\":\"auth\"," +
                "\"AccessKeyId\":\"%s\"," +
                ...
                "\"cid\":\"%s\"" +
                "}";
        return String.format(format,HuobiConsts.SIGNATURE_VERSION, apiKey,signature, HuobiConsts.SIGNATURE_METHOD,  now, clientId);
    }


    public String toUnsub() {
        return "";
    }


    private String createSignature(String gmtNow) {
        StringBuilder sb = new StringBuilder(1024);
        sb.append("GET").append('\n') // GET
                .append(HuobiConsts.API_HOST + ":443").append('\n') // Host
                .append(WS_PATH).append('\n'); // /path
        ...
        return HmacSHA256Signer.sign(sb.toString() + joiner.toString(), secretKey);
    }
